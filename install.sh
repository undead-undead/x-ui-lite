...
RELEASE_URL="https://github.com/undead-undead/x-ui-lite/releases/download/v2.5.0/x-ui-linux-${arch}.tar.gz"
...
install_xray() {
    ...
    local keygen_url="https://github.com/undead-undead/x-ui-lite/releases/download/v2.5.0/${keygen_file}"

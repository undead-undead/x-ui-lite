...
RELEASE_URL="https://github.com/undead-undead/x-ui-lite-v2/releases/download/v2.5.0/x-ui-linux-${arch}.tar.gz"
...
install_xray() {
    ...
    local xray_lite_url="https://github.com/undead-undead/x-ui-lite-v2/releases/download/v2.5.0/${xray_lite_file}"
    ...
    local keygen_url="https://github.com/undead-undead/x-ui-lite-v2/releases/download/v2.5.0/${keygen_file}"

...
RELEASE_URL="https://github.com/undead-undead/x-ui-lite/releases/download/v2.5.14/x-ui-linux-${arch}.tar.gz"
...
install_xray() {
    ...
    local xray_lite_url="https://github.com/undead-undead/x-ui-lite/releases/download/v2.5.14/${xray_lite_file}"
